...
The model is tuned conservatively. It rarely blocks legitimate email (only ~1.2% false alarm rate) but misses roughly 1 in 6 spam messages. That's the right trade-off for most use cases, since a missed newsletter is far less damaging than a blocked job offer.
